...
library(memisc)
setwd("C:/workspace/bigdata/R")
data.spss <- as.data.set(spss.system.file('data/drinking_water.sav', , encoded = 'utf-8'))
data.spss
View(data.spss)
...
# [실습] 기술 통계량 구하기
result <- read.csv("C:/workspace/bigdata/R/data/product.csv", header=TRUE)
