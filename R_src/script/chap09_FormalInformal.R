...
# (2) 텍스트 자료 가져오기
facebook <- file("data/facebook_bigdata.txt",encoding = "UTF-8")
facebook
...
write.csv(news_data, "output/news_data.csv", quote = F)

news_data <- read.csv("output/news_data.csv", header = T, stringsAsFactors = F)
str(news_data)
