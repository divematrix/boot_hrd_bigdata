...
# 가장 최근 그래프 저장
ggsave(file="output/diamond_price.pdf")
ggsave(file="output/diamond_price.jpg", dpi=72)
...
ggsave(file="output/diamond_price.png",plot=p,width=10, height=5)
...
ggsave("output/pop201901.png", scale = 1, width = 10.24, height = 7.68)
