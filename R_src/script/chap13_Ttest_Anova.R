...
# 단계1. 실습데이터 가져오기
data <- read.csv("C:/workspace/bigdata/R/data/one_sample.csv", header = T)
head(data)
View(data)
...
# 단계1. 실습데이터 가져오기
data <- read.csv("C:/workspace/bigdata/R/data/two_sample.csv", header = T)
head(data)
str(data)
View(data)
...
# 단계1. 실습 파일 가져오기
data <- read.csv("C:/workspace/bigdata/R/data/paired_sample.csv", header = T)
...
data <- read.csv("C:/workspace/bigdata/R/data/three_sample.csv", header = T)
View(data)
head(data)
str(data)
summary(data)
